...
<div class="row">
  <div class="col-2">
    <label for="dni" class="visually-hidden">Ingrese el DNI</label>
...
function guarda_novedad(){
    ...
    justificacion = document.getElementById('justificaciones').value;
    
    if(document.getElementById('fecha_hasta'))
    ...
    //persona_id = document.getElementById('personas_id').value;
